...
import querybuilderconfig.TableSchema.CategorySchema;
...
public class Category implements TableWithChild {
	...
	public void setID(long id) {
		...
		this.id = id;
		settedData.put(querybuilderconfig.TableSchema.CategorySchema.CATEGORYID.getColumnName(), getID());
	...
	public String getPrimaryIDName() {
		...
		return querybuilderconfig.TableSchema.CategorySchema.CATEGORYID.getPrimaryKey();
	}

	public String getTableName() {

		return querybuilderconfig.TableSchema.CategorySchema.CATEGORYID.getTableName();
	}
	...
	public void setCreatedAt(long createdAt) {
		...
		settedData.put(querybuilderconfig.TableSchema.CategorySchema.CREATEDTIME.getColumnName(), getCreatedAt());
	...
	public void setModifiedAt(long modifiedAt) {
		...
		settedData.put(querybuilderconfig.TableSchema.CategorySchema.MODIFIEDTIME.getColumnName(), getModifiedAt());
	}
	...
	public void setCategoryName(String CategoryName) {
		...
		settedData.put(querybuilderconfig.TableSchema.CategorySchema.CATEGORYNAME.getColumnName(), getCategoryName());
	}
	...
	public void setCreatedBY(long createdby) {
		...
		settedData.put(querybuilderconfig.TableSchema.CategorySchema.CREATEDBY.getColumnName(), getCreatedBy());
	}
