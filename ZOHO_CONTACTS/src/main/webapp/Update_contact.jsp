...
<div class="container">
        ...
        %>
            ...
            <input type="text" name="f_name"  value="<%=uc.getFname()%>" required />
             
             
             <label for="name">MiddleName</label>
            <input type="text"     value="<%=uc.getMname()%>"  name="m_name"   />
            
            <label for="name">LastName</label>
            <input type="text"   value="<%=uc.getLname()%>"   name="l_name"  />
            
            
            <label for="phoneno">Phone No</label>
            <input type="text" name="phone"  value="<%=uc.getPhoneno()%>" required />

            <label for="email">Email</label>
            <input type="email" name="email"  value="<%=uc.getEmail()%>" required />
...
  
          ...
          <input type="hidden" name="contactid"  value="<%=uc.getContactid() %>" required />
